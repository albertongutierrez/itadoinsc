...
<div class="content-wrapper" style="overflow:hidden;">
		<h2 style="text-align: center;" class="site-title">Relación Pre-Inscritos en Línea y sus Pagos</h2>
					...
					<form class="form-inline" role="form" action="php/filtrar-inscritos.php" method="post">
					 <br>
						 <div class="form-group">
						 	<input type="hidden" name="pagina" value="rep-relacion-inscritos">			
	            ...
	            <br>	        	
						<thead>
							<tr>
								...
								<!-- <th>Inscrito en</th>								 -->
								<th>Frec. <br> Participantes</th>
								<th>Porc. <br> Participantes</th>
								<th>Frec. <br> Acompañantes</th>
								<th>Porc. <br> Acompañantes</th>
								<th>Frec. <br> Niños</th>								
								<th>Porc. <br> Niños</th>								
								<!-- <th>Por defecto</th> -->									
							</tr>
						...
						<tbody>
						<?php 
							$query=extraerRepRelacionInscritos($_SESSION['crmRanking'],$_SESSION['crmEmpresa'], $gact, $grev);
							if($query->num_rows > 0){
								while ( $row= $query->fetch_assoc()) { 
									...
									echo "
									<td>".number_format($row['participantes'],2)."</td>
									<td>".number_format(($row['participantes']*100)/$row['total'],2)."%</td>
									<td>".number_format($row['acompanantes'],2)."</td>
									<td>".number_format(($row['acompanantes']*100)/$row['total'],2)."%</td>
									<td>".number_format($row['ninos'],2)."</td>
									<td>".number_format(($row['ninos']*100)/$row['total'],2)."%</td>
									</tr>";
								}
