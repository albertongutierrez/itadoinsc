						...
						<?php 
							...
							if($query->num_rows > 0){
								while ( $row= $query->fetch_assoc()) { 
									...
									if($_SESSION['crmRanking']==1 or $_SESSION['crmRanking']==2){echo "<td><a href='provincias-pais-actualizar.php?accion=UDT&empresa=".$row['codempresa']."&id=".$row['codprovincia']."'><img src='img/lapiz.png' width=15/></a> </td>";}
									 if($_SESSION['crmRanking']==1 or $_SESSION['crmRanking']==2){echo "<td> <a href='php/provincias-pais-registros.php/?accion=DLT&id=".$row['codprovincia']."&empresa=".$row['codempresa']."'><img src='img/basura.png' width=15/></a> </td>";}
